    ...
    for coord in coords:
        ...
        for adjacent in adjacent_coords:
            ...
            if adjacent_coord in symbols:
                ...
                if coord_number_dict.get(str(adjacent_coord)):

                    result += number * coord_number_dict.get(str(adjacent_coord))
                    
                else:
                    coord_number_dict.update({ str(adjacent_coord): number })
